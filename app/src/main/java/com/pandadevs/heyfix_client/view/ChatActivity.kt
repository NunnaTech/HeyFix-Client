...
class ChatActivity : AppCompatActivity() {
    ...
    private fun initView() {
        chatModel = intent.getSerializableExtra(CHAT_MODEL) as RateChatModel
        Glide.with(this).load(chatModel.worker_picture).into(binding.civPicture)
        binding.tvName.text = chatModel.worker_name
